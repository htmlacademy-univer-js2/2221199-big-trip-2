    ...
    `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
            <form class="trip-events__trip-sort  trip-sort" action="#" method="get">
              ...
              <div class="trip-sort__item  trip-sort__item--event">
                ...
                <label class="trip-sort__btn" for="sort-event" data-sort-type="${SORT_TYPES.EVENT}">Event</label>
              </div>
              ...
              <div class="trip-sort__item  trip-sort__item--offer">
                ...
                <label class="trip-sort__btn" for="sort-offer" data-sort-type="${SORT_TYPES.OFFERS}">Offers</label>
              </div>
            </form>`
  );
};
